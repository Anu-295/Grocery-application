...
public class Listeners extends Base implements ITestListener {//ITestL is interface. overriding the methods of itestlistenres
	  ...
	  ExtentTest test;   
	 	...
	 	ThreadLocal<ExtentTest> extentTest = new ThreadLocal<ExtentTest>();  //for thread safety during // execution
	  
	 	public void onTestStart(ITestResult result) {  //calling  at the time of test starting
