package utilities;
	...
	public class ExtentReportUtility {//to generate detailed and customized report
...
//path reporter
			...
			extentReports.attachReporter(reporter); // reporter is instance of path reporter which is attatched to  extentreport
